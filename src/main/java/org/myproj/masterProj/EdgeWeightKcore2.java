...
public class EdgeWeightKcore2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		int totalVertex  = subgraph.vertexSet().size();
		System.out.println(" subgraph vertex : "+ totalVertex);
		int totalEdges = subgraph.edgeSet().size();
		System.out.println(" subgraph edges : "+  totalEdges);
		System.out.println("---------------------------------------");
		System.out.println("---------------------------------------");
		int totalVertex1  = graph1.vertexSet().size();
		System.out.println(" graph vertex : "+ totalVertex1);
		int totalEdges1 = graph1.edgeSet().size();
		System.out.println(" graph edges : "+  totalEdges1);
		System.out.println("---------------------------------------");
		...
		System.out.println(" *****total time in millis:"+ timeElapsed1);
	}
